...
# License: GPLv3 Copyright: 2017, Kovid Goyal <kovid at kovidgoyal.net>, 2021 Peter <roswen9 at gmail.com>
...
from calibre_plugins.dsreader_helper.srv.handler import Handler
...
def log_paths():
    return os.path.join(cache_dir(), 'server-dsreader-log.txt'), os.path.join(
        cache_dir(), 'server-dsreader-access-log.txt'
    )
